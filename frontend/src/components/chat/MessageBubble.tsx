...
function VideoAttachment({ src, externalUrl, externalLabel }: VideoAttachmentProps) {
    ...
    <div className="group relative w-full max-w-[320px]">
      {active ? (
        ...
        <button
          ...
          className="flex aspect-video w-full items-center justify-center rounded-lg border border-border/20 bg-black text-white/90 transition-colors hover:text-white cursor-pointer"
        >
